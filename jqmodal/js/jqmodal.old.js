...
$.extend({
    ...
    ,jqModal:function(o){
        ...
        var isIE6=$.isIE6()
            ...
            ,setPos:function (){
                ...
                if (isIE6&&o.fixed) {
                    $.jqModal.top=s.maxT / 2;
                    $w.on('scroll',function(){
                        obj.box.css({'top':$.jqModal.top+$w.scrollTop()})
                    });
                };
   ...
   $('<link rel="stylesheet">').appendTo('head').attr('href', (typeof(tplurl)!='undefined'?tplurl:'')+'css/modal.css');
    ...
    $.jqModal.tip=function(o,t,s) {
        ...
        return $.jqModal($.extend(true, {}, $.jqModal.opt, opt));
    }
    // lay
    $.jqModal.lay=function(type,content,width,height) {
        var opt={
            modalType :'lay'
            ,fixed    :0
            ,lock     :0
        ...
        return $.jqModal($.extend({}, $.jqModal.opt, opt));
    }
})(jQuery);
