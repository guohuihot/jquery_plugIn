...
window['Rainbow'] = (function() {
   ...
   /**
    ...
    function _highlightCodeBlock(code_blocks, i, onComplete) {
        if (i < code_blocks.length) {
            ...
            if (!_hasClass(block, 'rainbow') && language) {
                ...
                _pre.innerHTML = '<code>' + code + '</code>';
                insertAfter(_pre, block);
    ...
    function _highlight(node, onComplete) {
        ...
        var pre_blocks = node.getElementsByTagName('textarea'),
            i,
            final_pre_blocks = [],
            final_code_blocks = [];
        ...
        for (i = 0; i < pre_blocks.length; ++i) {
            ...
            if (pre_blocks[i].getElementsByTagName('textarea').length) {
        ...
        for (i = 0; i < pre_blocks.length; ++i) {
            final_code_blocks.push(pre_blocks[i]);
        }
